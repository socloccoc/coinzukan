...
class CreateListUnstyledJapansTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('list_unstyled_japans', function (Blueprint $table) {
          $table->increments('id');
    ...
    {
        Schema::dropIfExists('list_unstyled_japans');
    }
}
